...
CoreVectorBlox footprint by size and compression configuration. Use this to decide which size (V250 / V500 / V1000) fits your target device and whether the compression variant is worth the extra fabric.
...
Source: [VectorBlox-SDK/docs/resource_utilization.md](https://github.com/Microchip-Vectorblox/VectorBlox-SDK/blob/master/docs/resource_utilization.md)
