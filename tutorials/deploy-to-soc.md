...
Before continuing, make sure the hardware is set up — see [PolarFire SoC Video Kit Quickstart]({% link hardware/polarfire-soc-video-kit/quickstart.md %}) for board setup instructions, including how to find the board's IP address.
